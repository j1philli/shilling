...
if [ ! -d "$ANDROID_HOME/platforms/android-36" ] || [ ! -d "$ANDROID_HOME/platforms/android-37.0" ]; then
    ...
    sdkmanager "platforms;android-36" "platforms;android-37.0" "build-tools;36.0.0" "platform-tools"
else
    echo "Android SDK (android-36 and android-37.0) already installed"
fi
